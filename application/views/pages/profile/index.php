			...
			<form action="<?= base_url('profile/update') ?>" method="post">
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						...
						<?= form_error('phone', '<small class="form-text ml-2 mt-1 text-danger">', '</small>') ?>
					</div>
				</div>
				<div class="form-group row">
					<label class="col-sm-2 col-form-label">Address</label>
					<div class="col-sm-10">
						<textarea class="form-control" name="address" id="" cols="30" rows="10"><?=$profile['address']?></textarea>
						<?= form_error('address', '<small class="form-text ml-2 mt-1 text-danger">', '</small>') ?>
					</div>
				</div>
