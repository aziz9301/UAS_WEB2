<nav class="navbar navbar-expand-lg navbar-light bg-light">
	<div class="container">
		<a class="navbar-brand" href="<?= base_url('home') ?>">
			<img src="<?= base_url() ?>/images/logo/console3.png" width="57" height="57"class="d-inline-block align-top" alt="logo" loading="lazy">
		</a>
					...
					<?php if($this->session->userdata('role') == 2) : ?>
						...
						<li class="nav-item dropdown active">
							<a class="nav-link dropdown-toggle mr-3" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								<i class="fas fa-user <?=$this->session->userdata['role']?>"></i>
							</a>
